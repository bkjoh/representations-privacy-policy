...
Representations: Binary & Hex is an offline iOS and iPadOS reference application for browsing and searching number-base, Unicode® Standard code point, and UTF-8 representation data. The application is designed to work locally on your device and does not transmit user data off the device.
